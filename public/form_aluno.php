            ...
            <form onsubmit="submitFormPost(event, 'aluno')" style="max-width: 600px; margin: 0 auto;">
                ...
                <div class="grid-cards" style="margin-bottom: 20px;">
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <select class="form-control" id="turma_id" name="turma_id" style="appearance: auto;">
                            <option value="" selected>Sem turma</option>
                            <?php if ($result_turmas && $result_turmas->num_rows > 0): ?>
                                <?php while ($turma = $result_turmas->fetch_assoc()): ?>
                                    <option value="<?php echo $turma['id']; ?>"><?php echo htmlspecialchars($turma['nome']); ?>
                                    </option>
                                <?php endwhile; ?>
                            <?php endif; ?>
                        </select>
