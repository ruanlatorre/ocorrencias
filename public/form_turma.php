...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="form_turma.php" class="menu-item active">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round">
    ...
    <main class="main-content">
        ...
        <div class="welcome-card" style="border-left: none;">
            <div class="header-actions"
                ...
                <a href="../tables/turma.php" class="btn-primary"
            ...
            if (isset($_GET['error'])) {
                if ($_GET['error'] == 'empty') {
                    ...
                    echo '<div class="alert alert-error">Erro ao cadastrar turma. Verifique se os IDs informados existem.</div>';
                }
            }
            ...
            <form action="../api/processa_turma.php" method="post" style="max-width: 600px;">
                ...
                <!-- Em um cenário real, Curso e Colaborador deveriam vir do banco via PHP ($result->fetch_assoc()...) -->
                <div class="form-group">
                    <label for="curso_id">ID do Curso</label>
                    <input type="number" class="form-control" id="curso_id" name="curso_id"
                        placeholder="Digite o ID do Curso correspondente" required>
                </div>

                <div class="form-group">
                    <label for="colaborador_id">ID do Colaborador (Responsável)</label>
                    <input type="number" class="form-control" id="colaborador_id" name="colaborador_id"
                        placeholder="Digite o ID do Colaborador">
                </div>

                <button type="submit" class="btn-primary" style="margin-top: 20px;">Salvar Turma</button>
            </form>
        </div>
    </main>
</body>
